                ...
                <div className="pt-32 pb-20 md:pt-40 md:pb-44">
                    ...
                    <div className="max-w-xl mx-auto md:max-w-none md:flex md:items-center md:space-x-8 lg:space-x-16 xl:space-x-20 space-y-16 md:space-y-0">
                        ...
                        <div className="text-center md:text-left md:min-w-[30rem]" data-aos="fade-right">
                            ...
                            <p className="text-xl text-slate-400 mb-8">Our landing page template works on all devices, so you only have href set it up once, and get beautiful results forever.</p>
                        ...
                        <div data-aos="fade-left">
                            ...
                            <div className="flex justify-center items-center">
                                <div className="relative">
                                    ...
                                    <Image className='mx-auto md:max-w-none'
                                        src={HeroImage}
                                        alt='Image'
                                        width="540"
                                        height="405"/>
                            ...
                            {/* Modal */}
                            <Modal id="modal" ariaLabel="modal-headline"
                                show={videoModalOpen}
                                handleClose={
