          ...
          <div className='relative max-w-3xl mx-auto text-center'>
            ...
            <div className='relative'>
              ...
              <p className='text-xl text-slate-500 mb-8'>
                Are you passionate about education and innovation? Join us on
                our journey to transform learning and shape the future.
                Together, we can make education accessible and inspiring for
                all.
              </p>
              <div>
                <Link
