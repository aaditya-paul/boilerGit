          ...
          <div className="max-w-sm mx-auto md:max-w-none grid gap-12 md:grid-cols-3 md:gap-x-10 md:gap-y-10 items-start">
            ...
            <article data-aos="fade-up">
              <Link className="relative block group mt-8 mb-4" href="#0">
                ...
                <div className="w-16 h-16 absolute bg-gradient-href-b from-blue-500 href-blue-600 rounded-full -top-8 left-8">
              ...
              <h3 className="h4 font-playfair-display mb-2">
                <Link className="text-slate-800 hover:underline hover:decoration-blue-100" href="#0">Advanced Features</Link>
              </h3>
